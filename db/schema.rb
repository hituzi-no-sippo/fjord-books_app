...
ActiveRecord::Schema.define(version: 2021_02_25_054056) do
  ...
  create_table "user_followings", force: :cascade do |t|
    ...
    t.index ["following_id", "follower_id"], name: "index_user_followings_on_following_id_and_follower_id", unique: true
